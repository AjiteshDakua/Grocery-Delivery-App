...
export const heroSectionData = {
  description:
    "Shop fresh vegetables, fruits, dairy, and daily essentials from trusted local stores with fast delivery and live order tracking right to your doorstep.",
  hero_image: hero_bg,
  hero_features: [
...
export const appPromoBannerData = {
  ...
  description:
    "Download the ZapCart app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};
...
export const footerData = {
  ...
  contact: [
    {
      icon: MapPinIcon,
      text: "12 Salt Lake Sector V, Kolkata, West Bengal 700091",
    },
    { icon: PhoneIcon, text: "+91 98765 43210" },
    { icon: MailIcon, text: "support@zapcart.com" },
  ],

  bottom: {
    copyright: "© 2026 ZapCart by Ajitesh. All rights reserved.",
    links: [
