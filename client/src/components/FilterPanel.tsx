    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="w-full px-3 text-sm bg-white rounded-lg border not-focus:border-app-border"
          />
      ...
      {hasFilters && (
        <button
          ...
          className="w-full py-2 text-sm text-app-error hover:bg-red-100 rounded-lg transition-colors font-medium"
        >
          Clear Filter
        </button>
      )}
