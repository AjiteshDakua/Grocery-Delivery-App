    ...
    <section className="bg-white py-18 px-4 sm:px-8 lg:px-8 rounded-3xl mx-auto shadow-xs mt-32 mb-20">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-app-text-light mb-8 text-base">
          Stay updated with fresh deals, healthy recipes, and fast grocery
          delivery every week.
        </p>
        <form
        ...
        >
          <input
            ...
            required
            className="flex-1 px-5 py-3.5 rounded-2xl border border-app-border focus:border-app-green focus:ring bg-white text-sm transition-all hover:bg-orange-50"
          />
          <button
            type="submit"
