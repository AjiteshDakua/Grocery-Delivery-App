...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side */}
      <div className="hidden lg:flex lg:w1/2 bg-app-green relative items-center justify-center ">
        <img
        ...
        <div className="relative text-center px-12 ">
          <h2 className="text-4xl font-semibold text-white mb-4 ">
            Welcome back to ZapCart
          </h2>
          <p className="text-white/60 font-serif text-xl max-w-sm mx-auto ">
            Your trusted grocery delivery partner, bringing fresh products,
            daily essentials, and fast doorstep delivery with real-time order
            tracking for a smooth and reliable shopping experience.
          </p>
        </div>
      </div>
      {/* Right side */}
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-app-text-light">
              ...
              <button
                ...
                className="text-orange-500 ml-1 font-semibold hover:bg-orange-600 transition-colors"
              >
