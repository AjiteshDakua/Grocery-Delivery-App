  ...
  useEffect(() => {
    ...
    const fetchLocation = async () => {
      try {
        ...
        // Also update over status if it changed
              ...
              order.status !== "Cancelled" && (
                <div className="bg-white rounded-2xl p-5 flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="p-2 bg-app-cream rounded-xl hover:bg-app-cream-dark transition-colors"
                  >
              ...
              <div className="mt-4 pt-3 border-t border-app-border space-y-1.5 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {order?.handlingFee === 0
                      ? "Free"
                      : `${currency}${order?.handlingFee.toFixed(2)}`}
                  </span>
                </div>
