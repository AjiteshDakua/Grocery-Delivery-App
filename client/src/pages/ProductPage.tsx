...
const ProductPage = () => {
    ...
    const [relateProducts, setRelatedProducts] = useState<Product[]>([]);
    ...
    return (
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 sm:px-8 py-6">
                ...
                <button
                    onClick={() => navigate(-1)}
                    className="mb-6 flex items-center gap-1.5 text-sm text-app-green-light hover:text-app-green transition-colors"
                >
                    <ArrowLeftIcon className="size-4" /> Back
                </button>
                {/* product details section */}
                <div className="bg-white/50 rotate-2xl overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                        ...
                        <div className=" relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
                            <img
                                src={product.image}
                                alt={product.name}
                                className="max-h-[360px] w-auto object-centain"
                            />
                            {/* Badhes */}
                            <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                                {product.isOrganic && (
                                    <span className="flex items-center gap-1 px-2.5 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full">
                        ...
                        <div className="p-6 md:p-10 flex flex-col justify-center">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
                                    <button
                                        onClick={handleMinus}
                                        className="p-3 hover:bg-red-50 text-zinc-700 hover:text-red-500 transition-colors"
                                    >
                                    ...
                                    <button
                                        onClick={handlePlus}
                                        className="p-3 hover:bg-green-50 text-zinc-700 hover:text-green-600 transition-colors"
                                    >
                                ...
                                >
                                    ...
                                    {inCart ? "Added to card" : "Add to cart"}
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                {relateProducts.length > 0 && (
                    <section className="mt-12 mb-44">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 xl:gap-8">
