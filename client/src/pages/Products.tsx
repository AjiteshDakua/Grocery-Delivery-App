          ...
          <main className="flex-1 bg">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm to-app-text-light mt-0.5">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative ">
                  <select
                    ...
                    className="appearance-none pl-3 pr-8 py-2 text-sm bg-app-cream rounded-xl border border-app-border focus:border-app-green outline-none cursor-pointer "
                  >
